...
namespace MeshBrush
{
    ...
    {
        private MeshBrush meshBrush;
        private MeshBrushParent meshBrushParent;
        ...
        private SerializedProperty globalPaintingMode;
        private SerializedProperty showGlobalPaintingLayersInspector;
        private SerializedProperty collapsed;
        private SerializedProperty layerMask;
        private SerializedProperty stats;
        private SerializedProperty lockSceneView;
        private SerializedProperty classicUI;
        private SerializedProperty previewIconSize;
        private SerializedProperty meshes;
        private SerializedProperty deactivatedMeshes;
        private SerializedProperty radius;
        private SerializedProperty color;
        private SerializedProperty quantityRange;
        private SerializedProperty useDensity;
        private SerializedProperty densityRange;
        private SerializedProperty delay;
        private SerializedProperty offsetRange;
        private SerializedProperty slopeInfluenceRange;
        private SerializedProperty useSlopeFilter;
        private SerializedProperty angleThresholdRange;
        private SerializedProperty inverseSlopeFilter;
        private SerializedProperty manualReferenceVectorSampling;
        private SerializedProperty showReferenceVectorInSceneView;
        private SerializedProperty slopeReferenceVector;
        private SerializedProperty slopeReferenceVectorSampleLocation;
        private SerializedProperty yAxisTangent;
        private SerializedProperty strokeAlignment;
        private SerializedProperty lastPaintLocation;
        private SerializedProperty brushStrokeDirection;
        private SerializedProperty scatteringRange;
        private SerializedProperty useOverlapFilter;
        private SerializedProperty minimumAbsoluteDistanceRange;
        private SerializedProperty uniformRandomScale;
        private SerializedProperty uniformAdditiveScale;
        private SerializedProperty randomScaleRange;
        private SerializedProperty randomScaleRangeX;
        private SerializedProperty randomScaleRangeY;
        private SerializedProperty randomScaleRangeZ;
        private SerializedProperty randomScaleCurve;
        private SerializedProperty randomScaleCurveVariation;
        private SerializedProperty additiveScaleRange;
        private SerializedProperty additiveScaleNonUniform;
        private SerializedProperty randomRotationRangeX;
        private SerializedProperty randomRotationRangeY;
        private SerializedProperty randomRotationRangeZ;
        private SerializedProperty positionBrushRandomizer;
        private SerializedProperty rotationBrushRandomizer;
        private SerializedProperty scaleBrushRandomizer;
        private SerializedProperty autoIgnoreRaycast;
        private SerializedProperty autoStatic;
        private SerializedProperty autoSelectOnCombine;

        #region Key bindings

        private SerializedProperty paintKey;
        private SerializedProperty deleteKey;
        private SerializedProperty combineKey;
        private SerializedProperty randomizeKey;
        private SerializedProperty increaseRadiusKey;
        private SerializedProperty decreaseRadiusKey;

        #endregion

        #region Foldouts

        private SerializedProperty helpFoldout;
        private SerializedProperty helpTemplatesFoldout;
        private SerializedProperty helpGeneralUsageFoldout;
        private SerializedProperty helpOptimizationFoldout;
        private SerializedProperty meshesFoldout;
        private SerializedProperty templatesFoldout;
        private SerializedProperty keyBindingsFoldout;
        private SerializedProperty brushFoldout;
        private SerializedProperty slopesFoldout;
        private SerializedProperty randomizersFoldout;
        private SerializedProperty overlapFilterFoldout;
        private SerializedProperty additiveScaleFoldout;
        private SerializedProperty optimizationFoldout;

        #endregion

        #region Range limits

        private SerializedProperty maxQuantityLimit;
        private SerializedProperty maxDelayLimit;
        private SerializedProperty maxDensityLimit;
        private SerializedProperty minOffsetLimit;
        private SerializedProperty maxOffsetLimit;
        private SerializedProperty maxMinimumAbsoluteDistanceLimit;
        private SerializedProperty maxAdditiveScaleLimit;
        private SerializedProperty maxRandomScaleLimit;

        #endregion

        #endregion

        private static List<string> favouriteTemplates = new List<string>(15);
        ...
        private Action activeBrushMode;

        // Default brush mode should be paint.
        private BrushMode brushMode = BrushMode.Paint;

        private Vector2 templatesScroll = Vector2.zero; // 2D Vectors used for scrollbars.
        private Vector2 layersScroll = Vector2.zero;
        private Vector2 setScroll = Vector2.zero;

        // And here comes the raycasting part...
        private Ray ray;          // This is the screen ray that shoots out of the scene view's camera when we press the paint button...
        private RaycastHit hit;   // And this is its raycasthit.

        private int globalPaintLayerMask = 1;
        private float radiusModAcceleration = 1.0f;

        private int totalPaintedMeshes;
        private int totalPaintedTris;

        private int currentObjectPickerIndex;

        private static bool gizmosEnabled = true;
        private static readonly string[] layerNames = new string[32];
        private static readonly Color disabledMeshThumbnailColor = Color.red;
        ...
        private static void CreateMeshBrushInstance() // This function gets called every time we click the above defined menu entry (since it is being defined exactly below the [MenuItem()] statement).
        {
        ...
        private static void CreateGlobalPaintingInstance()
        {
        ...
        private void OnEnable()
        {
            ...
            gizmosEnabled = GetSceneViewGizmosEnabled();
        ...
        private void UpdatePaintLayerMask()
        {
        ...
        private void OpenRangeLimitsWizard()
        {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!gizmosEnabled)
            {
                EditorGUILayout.HelpBox("Warning:\n\nGizmos disabled.\n\nMeshBrush does not work without scene view gizmos!\n\nRe-enable gizmos to use MeshBrush.", MessageType.Warning);
            }
        ...
        private void MainInspectorSettings()
        {
            EditorGUILayout.BeginHorizontal();
            {
        ...
        private void GlobalPaintingModeInspector()
        {
        ...
        private void UnlinkedMeshBrushInstanceInspector()
        {
        ...
        private void MissingColliderInspector()
        {
            if (meshBrush.CachedCollider == null && !globalPaintingMode.boolValue)
            {
        ...
        private void HelpSectionInspector()
        {
        ...
        private void TrisCounterInspector()
        {
            if (stats.boolValue)
            {
                EditorGUILayout.BeginVertical("Box");
            ...
            if (templatesFoldout.boolValue)
            {
                EditorGUILayout.BeginHorizontal();
                {
                    GUILayout.BeginVertical(GUILayout.MaxWidth(57f));
                    {
                        ...
                        {
                            string templateFilePath = EditorUtility.SaveFilePanelInProject("Select template file storage path", "<insert template name here>", "xml", "A MeshBrush template contains all the relevant settings of a MeshBrush instance.\nIt can be saved from and loaded into a MeshBrush instance and makes swapping settings setups in/out easy.");
                        ...
                        if (GUILayout.Button(new GUIContent(EditorIcons.LoadTemplateIcon, "Load up a template file."), GUILayout.Height(55f), GUILayout.Width(55f)))
                        {
                            ...
                            string templateFilePath = EditorUtility.OpenFilePanel("Select template file to load", "/Assets", "xml");
                            if (!string.IsNullOrEmpty(templateFilePath))
                            {
        ...
        private void ClassicSetOfMeshesToPaintInspector()
        {
            EditorGUILayout.BeginVertical("Box");
            {
        ...
        private void ModernSetOfMeshesToPaintInspector()
        {
            EditorGUILayout.BeginVertical("Box");
            {
        ...
        private void KeyBindingsInspector()
        {
        ...
        private void BrushSettingsInspector()
        {
        ...
        private void SlopeSettingsInspector()
        {
        ...
        private void RandomizersInspector()
        {
        ...
        private void OverlapFilterInspector()
        {
        ...
        private void AdditiveScaleInspector()
        {
        ...
        private void OptimizationInspector()
        {
        ...
        private void DrawMinMaxSlider(SerializedProperty rangeVector2, float minLimit, float maxLimit, int fractionalDigits = -1)
        {
        ...
        /// <param name="minLimit">Minimum range limit.</param>
        /// <param name="maxLimit">Maximum range limit.</param>
        private void DrawMinMaxSlider(SerializedProperty rangeVector2, int minLimit, int maxLimit)
        {
            float min = rangeVector2.vector2Value.x;
            float max = rangeVector2.vector2Value.y;
        ...
        private void UpdateTrisCounter()
        {
        ...
        private void NullifySetOfMeshesToPaint()
        {
            for (int i = 0; i < meshes.arraySize; i++)
            {
        ...
        private void ClearSetOfMeshesToPaint()
        {
            meshes.ClearArray();
            meshes.arraySize = 0;
            AddMeshToPaint(null);
        ...
        private void BrushMode_MeshPaint() // This method represents the MeshPaint mode for the brush. This is the default brush mode.
        {
            currentEvent = Event.current;
        ...
        private void BrushMode_PrecisionPlacement() // Mode for the precise placement of single meshes.
        {
            currentEvent = Event.current;
            for (int i = 0; i < meshes.arraySize; i++)
            {
            ...
            string selectedArrayElementGameObjectName = selectedArrayElementGameObject.name;
        ...
        private readonly List<Vector3> referenceVectors = new List<Vector3>(7);
        private float nextReferenceVectorsFlicker;
        private bool referenceVectorsFlickerState;
        ...
        private void BrushMode_SampleReferenceVector()
        {
            if (Selection.gameObjects.Length == 1 && Selection.activeGameObject.transform == meshBrush.CachedTransform)
            {
                ray = HandleUtility.GUIPointToWorldRay(Event.current.mousePosition);
        ...
        private Vector3 GetAveragedVector(List<Vector3> inputVectors)
        {
        ...
        private static bool GetSceneViewGizmosEnabled()
        {
            SceneView sv = EditorWindow.GetWindow<SceneView>();
            return sv != null && sv.drawGizmos;
        }
    }
}
