...
namespace MeshBrush
{
    ...
    public class SaveCombinedMeshEditor : Editor
    {
        ...
        {
            SaveCombinedMesh saveCombinedMesh = (SaveCombinedMesh)target;
            MeshFilter meshFilter = saveCombinedMesh.GetComponent<MeshFilter>();
